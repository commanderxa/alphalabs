  ...
  groups: [
    {
      name: "Kinematics",
      description:
        "Kinematics is the branch of mechanics that focuses on describing the motion of objects without considering the forces that cause this motion. It deals with parameters such as displacement (change in position), velocity (rate of change of position), and acceleration (rate of change of velocity). By analyzing these parameters, kinematics provides a framework to predict future motion based on initial conditions.",
      simulations: [
        {
          name: "1D Motion",
          description:
        ...
        },
        {
          name: "Free Fall",
          description:
            "Demonstrates the motion of objects under the influence of gravity alone, highlighting acceleration due to gravity.",
    ...
    },
    {
      ...
      simulations: [
        ...
        },
        {
          ...
          description:
            "Demonstrates the relationship between force, mass, and acceleration, emphasizing how force influences motion.",
          img: "dynamics_2.png",
        ...
        },
        {
          ...
          description:
            "Explores action-reaction force pairs, showing how forces between two objects are equal in magnitude and opposite in direction.",
          img: "dynamics_3.png",
        ...
        },
        {
          name: "Center of Mass",
          description:
            "Examines the Center of Mass on randomly distributed objects in space with random masses.",
          img: "dynamics_4.png",
    ...
    },
    {
      name: "Momentum",
      description:
        "Momentum is a fundamental concept that quantifies the motion of an object, defined as the product of its mass and velocity. It is a vector quantity, possessing both magnitude and direction. The principle of conservation of momentum states that in a closed system with no external forces, the total momentum remains constant. This principle is crucial in analyzing interactions such as collisions, where understanding momentum transfer helps predict post-collision velocities and directions.",
      simulations: [
        {
          name: "Collisions",
          description:
            "Investigates elastic and inelastic collisions, emphasizing the conservation of momentum and energy transfer during interactions.",
          img: "momentum_1.png",
      ...
      simulations: [
        {
          name: "Lever",
          description:
            "Explores the mechanics of levers, demonstrating how forces and distances influence rotational equilibrium.",
          img: "statics_1.png",
        ...
        },
        {
          name: "Inclined Plane",
          description:
            "Examines the forces acting on objects on a slope, including gravitational components and normal force, to understand equilibrium conditions.",
          img: "statics_2.png",
